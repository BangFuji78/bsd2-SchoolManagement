        ...
        <div class="content-inner-all">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Orangtua</span>
                                            </li>
                                        </ul>
                                        <form method="post">
                                            ...
                                            <button class="btn btn-primary pull-right" type="submit" name="tambah">
                                                <span class="fa fa-plus"></span> Tambah Orangtua
                                            </button>
                                        </form>
                                        <?php if(isset($_POST['tambah'])){
                                                $_SESSION['tambah']['user']=$_POST['user'];
                                                goToRedirect('tambah-orangtua.php',0);
                                            } ?>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <ul class="breadcome-menu">
                                                ...
                                                <li><span class="bread-blod">Orang Tua</span>
                                                </li>
                                            </ul>
                                            <form method="post">
                                                <button class="btn btn-primary">
                                                    <span class="fa fa-plus"></span> tambah Orang Tua
                                                </button>
                                            </form>
                                        </div>
                                    </div>
             ...
             <?php 
                        if(isset($_POST['delete'])){
                            if(del($_POST['del_id'],"admin",$mysqli)){
                                goToRedirect('orangtua-user.php',0);
                            }
                        }elseif (isset($_POST['edit'])) {
                            goToRedirect("tambah-orangtua.php?id=".base64_encode(date("d/m/y")."-".$_POST['del_id']));
                        }
                     ?>
            <div class="contact-clients-area mg-b-40">
                <div class="container-fluid">
                    ...
                    $sql="SELECT * FROM `parent` WHERE status ='1'";
