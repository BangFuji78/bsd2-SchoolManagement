...
<body class="materialdesign">
    ...
    <div class="wrapper-pro">
        ...
        <div class="content-inner-all">
            ...
            <?php 
                if(isset($_GET['id'])) {
                    include('edit-rombel.php');
                }elseif(!isset($_SESSION['tambah']['user'])){
                    gotoRedirect('index.php',0);
                }elseif(isset($_GET['idclass'])){
                    $idClass=substr(base64_decode($_GET['idclass']),strpos(base64_decode($_GET['idclass']),"-")+1);
                    ?>
                <!-- container start -->
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="all-form-element-inner">
                                                            ...
                                                            <div class="col-lg-12 form-group-inner">
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-8">
                                                                            <input type="text" class="form-control" name="nama" placeholder="example :'A'" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group-inner">
                                                        ...
                                                        <?php  if(isset($_POST['tambah'])){
                                                                ...
                                                                $sqlAdmin="INSERT INTO `section`(`name`, `teacher_id`, `class_id`) VALUES ('".$data['nama']."','".$data['guru']."','".$idClass."')";
