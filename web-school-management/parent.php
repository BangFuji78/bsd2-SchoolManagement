...
<div class="contact-clients-area mg-b-40">
                <?php
                    if(isset($_POST['delete'])){
                        if(del($_POST['del_id'],"parent",$mysqli)){
                            goToRedirect('parent.php',0);
                        }
                    }elseif (isset($_POST['edit-parent'])) {
                        goToRedirect('tambah-parent.php?id='.base64_encode(date("d/m/y")."-".$_POST['del_id']),0);
                    }
                ?>
                <div class="container-fluid">
                    <?php $sql="SELECT * FROM `parent` ";
                                        ...
                                        <div class="col-lg-8">
                                            <div class="contact-client-content">
                                                <form method="post">
                                                    ...
                                                    <input type="hidden" name="del_id" value="<?php echo $resl['parent_id']; ?>">
